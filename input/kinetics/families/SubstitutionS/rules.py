...
entry(
    index = 148,
    label = "S-Cs(HHH)Cs(HHH);S2sJ-S2s",
    kinetics = ArrheniusEP(
        A = (0.607, 'cm^3/(mol*s)'),
        n = 3.8,
        alpha = 0,
